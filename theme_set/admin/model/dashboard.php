			...
			{	
				...
				{	
					if($_SESSION['LOGIN_USER_TYPE']==2)
					{
						...
						$dataadmin = $this->query($sqladmin);//printr($dataadmin);
...
//	printr($data);
	...
	public function getAddDataSearch($fillter_data,$title){
	    
	    $sql="INSERT INTO count_module_usage SET 	module_name ='dashboard_serach-".$title."',user_id ='".$_SESSION['ADMIN_LOGIN_SWISS']."',user_type_id ='".$_SESSION['LOGIN_USER_TYPE']."' ";
	    	$data = $this->query($sql);
	}
