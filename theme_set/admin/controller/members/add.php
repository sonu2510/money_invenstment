            		...
            		<div class="form-group has-success">
                         <div class="row">
                                <label class="col-sm-2 control-label">Date</label>
                                     <div class="col-sm-3">
                                              <input type="date" name="date" value="<?php echo isset($branch['date'])?$branch['date']:'';?>" class="form-control validate[required]">
                                    </div>
                  ...
                  <div class="form-group has-success">
                         <div class="row">
                              <label class="col-sm-2 control-label">Amount</label>
                                     <div class="col-sm-3">
                                              <input type="text" name="amount" value="<?php echo isset($branch['amount'])?$branch['amount']:'';?>" class="form-control validate[required,custom[email]]">
                                    </div>   
                          </div>
                  </div>    
                  <div class="form-group has-success">
                         <div class="row">
                              <label class="col-sm-2 control-label">Remarks</label>
                                     <div class="col-sm-3">
                                             <textarea name="remarks" class="form-control "> <?php echo isset($branch['amount'])?$branch['amount']:'';?></textarea>
                                    </div>   
                          </div>
                  </div> 
