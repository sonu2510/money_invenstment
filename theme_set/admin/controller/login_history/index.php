        ...
        <div class="card">
         <div class="card-title">
              ...
              <?php if($obj_general->hasPermission('delete',$menuId)){ ?>       
                    <a class="btn btn-danger btn-outline m-b-10 m-l-5" onclick="formsubmitsetaction('form_list','delete','post[]','<?php echo DELETE_WARNING;?>')"><i class="fa fa-trash-o"></i> Delete</a>
              <?php } ?>
            </span>
          </div>
                      ...
                      foreach($reports as $report){ 
                        ...
                        <tr style="cursor:pointer" class="heading-row">
                          ...
                          <td><label class="label   
							<?php echo ($report['login_status']==1)?'btn btn-info btn-outline m-b-10 m-l-5':'btn btn-warning btn-outline m-b-10 m-l-5';?>">
